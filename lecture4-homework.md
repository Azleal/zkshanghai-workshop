...
> hardhat run scripts/download-snark-artifacts.ts && hardhat test
  ...
  Feedback
    # joinGroup
      ✔ Should allow users to join the group (738ms)
    # sendFeedback
      ✔ Should allow users to send feedback anonymously (2038ms)
...
> network:    hardhat
  ...
  Feedback
    # joinGroup
      ✔ Should allow users to join the group (751ms)
    # sendFeedback
      ✔ Should allow users to send feedback anonymously (2196ms)
